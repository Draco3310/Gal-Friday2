...
def pytest_addoption(parser):
    ...
    parser.addoption(
        "--run-network", action="store_true", default=False, help="run tests requiring network"
    )
    parser.addoption(
        "--run-exchange", action="store_true", default=False, help="run tests interacting with exchanges"
    )
