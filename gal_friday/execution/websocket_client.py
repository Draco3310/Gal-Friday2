...
class KrakenWebSocketClient:
    ...
    async def _handle_orderbook(self, message: list[Any]) -> None:
        ...
        try:
            ...
            await self._handle_processing_error(
                ProcessingError.PROCESSING_TIMEOUT,
                "Processing timeout for order book update",
    ...
    async def _publish_order_book_event(self, symbol: str, is_snapshot: bool) -> None:
        ...
        try:
            ...
            self.logger.exception(f"Error publishing order book event for {symbol}: ")
    ...
    async def _handle_processing_error(
        ...
        if self.error_recovery_enabled:
            try:
                ...
                self.logger.exception(f"Error recovery failed for {error_type.value}: ")

    async def _apply_error_recovery(self, error_type: ProcessingError, symbol: str | None) -> None:
