...
class ReconciliationEvent(Base):
    ...
    # reconciliation_id is PRIMARY KEY but not auto-generated by DB in the schema
    # (no DEFAULT uuid_generate_v4())
    ...
    def __repr__(self) -> str:
        """Return a string representation of the ReconciliationEvent."""
        return (
