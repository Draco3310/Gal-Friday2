...
"""
from typing import ClassVar  # For RUF012
...
class PublishedFeaturesV1(BaseModel):
    ...
    macd_default_macd_12_26_9: float = Field(..., examples=[0.5]) # N815
    macd_default_macdh_12_26_9: float = Field(..., examples=[0.1]) # N815
    macd_default_macds_12_26_9: float = Field(..., examples=[0.4]) # N815
    ...
    class Config:
        """Pydantic model configuration.""" # D106
        # Example for generating schema
        json_schema_extra: ClassVar[dict] = { # RUF012
            "example": {
                "rsi_14_default": 55.0,
                "macd_default_macd_12_26_9": -0.23, # N815 Updated example
                "macd_default_macdh_12_26_9": -0.05, # N815 Updated example
                "macd_default_macds_12_26_9": -0.18, # N815 Updated example
