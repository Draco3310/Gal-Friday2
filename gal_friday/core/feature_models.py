...
"""
from typing import Any  # For RUF012
...
class FeatureSpec(BaseModel):
    ...
    default_value: float | int | str | None = Field(
    ...
    def _apply_validation_rules(self, value: float | str) -> None:
...
class FeatureRegistry:
    ...
    def validate_features(self, features: dict[str, Any]) -> dict[str, Any]:
        ...
        for name, spec in self._specs.items():
            ...
            if not spec.required and name not in features:
...
class PublishedFeaturesV1(BaseModel):
    ...
    market_regime_indicator: str | None = Field(
        default="unknown",
    ...
    @classmethod
    def validate_volatility_percentile(cls, v: float | None) -> float | None:
    ...
    @classmethod
    def validate_liquidity_score(cls, v: float | None) -> float | None:
    ...
    @classmethod
    def validate_market_regime(cls, v: str | None) -> str | None:
