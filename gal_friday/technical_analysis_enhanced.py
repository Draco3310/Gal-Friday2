...
class IndicatorResult:
    ...
    indicator_type: IndicatorType
    values: np.ndarray[Any, Any] | tuple[np.ndarray[Any, Any], ...]
    ...
    def calculate(
        ...
        try:
            ...
            self.logger.exception(
                f"TA-Lib calculation failed for {indicator_config.indicator_type}: ",
...
class PandasTABackend(TechnicalAnalysisBackend):
    ...
    def calculate(
        ...
        try:
            ...
            self.logger.exception(
                f"Pandas-TA calculation failed for {indicator_config.indicator_type}: ",
                extra={"source_module": self._source_module},
            )
            raise
...
class CustomBackend(TechnicalAnalysisBackend):
    ...
    def calculate(
        ...
        try:
            ...
            self.logger.exception(
                f"Custom calculation failed for {indicator_config.indicator_type}: ",
                extra={"source_module": self._source_module},
            )
            raise
...
class TechnicalAnalysisManager:
    ...
    def __init__(self, config: dict[str, Any], logger: logging.Logger) -> None:
        ...
        self.calculation_stats: dict[str, int | float | dict[str, int]] = {
