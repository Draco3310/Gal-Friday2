...
class ExecutionEventBuilder:
    ...
    def _get_signal_id(self, fill: "Fill") -> uuid.UUID | None:
    ...
    def _get_client_order_id(self, fill: "Fill") -> str | None:
    ...
    def _get_limit_price(self, fill: "Fill") -> Decimal | None:
        ...
        if (fill.order and
            ...
            return cast("Decimal | None", fill.order.limit_price)

        return None

    def _get_stop_price(self, fill: "Fill") -> Decimal | None:
        ...
        if (fill.order and
            ...
            return cast("Decimal | None", fill.order.stop_price)
...
class ExecutionEventPublisher:
    ...
    def __init__(self, event_bus: Any | None = None) -> None:
        ...
        self.last_publication_time: datetime | None = None
    ...
    async def publish_execution_event(self, event: ExecutionReportEvent) -> bool:
        ...
        try:
            ...
            self.last_publication_time = datetime.now(UTC)
...
class Fill(Base):
    ...
    _event_builder: ClassVar[ExecutionEventBuilder | None] = None
    _event_publisher: ClassVar[ExecutionEventPublisher | None] = None
    ...
    def to_event(self) -> ExecutionReportEvent:
        ...
        try:
            ...
            logger.exception(f"Failed to create execution event for fill {self.fill_id}: ")
    ...
    async def publish_execution_event(self) -> bool:
        ...
        try:
            ...
            logger = logging.getLogger(__name__)
            logger.exception(f"Failed to publish execution event for fill {self.fill_id}: ")
            return False
