...
class HistoricalDataService(abc.ABC):
    ...
    async def get_historical_ohlcv(
        ...
        # DataFrame should have columns like ['timestamp', 'open', 'high', 'low', 'close', 'volume']
    ...
    async def get_historical_trades(
        ...
        # DataFrame should have columns like ['timestamp', 'price', 'volume', 'side']
        raise NotImplementedError
    ...
    # Add other methods if needed, e.g., for historical L2 data (more complex)