...
class MockPubSubManager:
    ...
    async def publish(self, event: dict):
        ...
        if event_type_str:
            ...
            except KeyError:  # noqa: S110 - test-complexity: acceptable to ignore invalid event types in mock pubsub for testing
...
def sample_feature_config() -> dict:
    ...
    return {
        ...
        "vol_delta_60s": {
            "calculator_type": "volume_delta",
            "input_type": "trades_and_bar_starts",
            "category": "TRADE_DATA",
