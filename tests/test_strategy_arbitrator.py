...
def test_strategy_arbitrator_strategy_loading(mock_breakout, mock_mean_reversion, mock_momentum, 
                                              strategy_config, event_bus):
...
@patch("gal_friday.strategies.mean_reversion_strategy.MeanReversionStrategy")
@patch("gal_friday.strategies.breakout_strategy.BreakoutStrategy")
def test_strategy_arbitrator_handle_market_data(mock_breakout, mock_mean_reversion, mock_momentum, 
                                                strategy_config, event_bus):
...
@patch("gal_friday.strategies.mean_reversion_strategy.MeanReversionStrategy")
@patch("gal_friday.strategies.breakout_strategy.BreakoutStrategy")
def test_strategy_arbitrator_vote_on_signals(mock_breakout, mock_mean_reversion, mock_momentum, 
                                           strategy_config, event_bus):
    ...
    mock_momentum_instance.get_current_signal.return_value = {"BTC/USD": {"direction": "BUY", "strength": 0.8}}
    mock_mean_reversion_instance.get_current_signal.return_value = {"BTC/USD": {"direction": "BUY", "strength": 0.7}}
    mock_breakout_instance.get_current_signal.return_value = {"BTC/USD": {"direction": "BUY", "strength": 0.9}}
    ...
    assert result["strength"] > 0.7  # Should be a weighted average of the signals
    
    # Scenario 2: Mixed signals (no clear consensus)
    mock_momentum_instance.get_current_signal.return_value = {"BTC/USD": {"direction": "BUY", "strength": 0.6}}
    mock_mean_reversion_instance.get_current_signal.return_value = {"BTC/USD": {"direction": "SELL", "strength": 0.7}}
    mock_breakout_instance.get_current_signal.return_value = {"BTC/USD": {"direction": "BUY", "strength": 0.5}}
    ...
    mock_momentum_instance.get_current_signal.return_value = {"BTC/USD": {"direction": "BUY", "strength": 0.4}}
    mock_mean_reversion_instance.get_current_signal.return_value = {"BTC/USD": {"direction": "BUY", "strength": 0.3}}
    mock_breakout_instance.get_current_signal.return_value = {"BTC/USD": {"direction": "BUY", "strength": 0.5}}
...
@patch("gal_friday.strategies.mean_reversion_strategy.MeanReversionStrategy")
@patch("gal_friday.strategies.breakout_strategy.BreakoutStrategy")
def test_strategy_arbitrator_generate_signals(mock_breakout, mock_mean_reversion, mock_momentum, 
                                           strategy_config, event_bus):
